...
def surface_create (*args):
    return pyv.pygame.Surface(*args)
...
class Block(pyv.pygame.sprite.Sprite):
    ...
    def __init__(self, color, x, y):
        ...
        self.image = surface_create([BLOCK_W, BLOCK_H])
...
class Ball(pyv.pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = surface_create([self.width, self.height])
...
def init_game(vmst=None):
    ...
    background = surface_create(screen.get_size())
    ...
    clock = pyv.vars.clock #create_clock()
