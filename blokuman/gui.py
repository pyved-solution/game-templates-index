...
class Button(kevent.EventReceiver):
    ...
    def refresh_img(self):
        ...
        if self.bg_color != self.HIDEOUS_PURPLE:
            textimg = self.font.render(self.txt, False, self.fg_color, self.bg_color)
        else:
...
#
#
# class TextInput(kevent.EventReceiver):
#     """
...
#             #    self.backspace_char()
#             self.text_img = self.font.render(content, False, self.text_color, self.fill_color)
