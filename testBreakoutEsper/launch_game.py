...
def prep_plugins(inj_obj, rel_import_flag, plugins_list):
    for alias, plugin in plugins_list:
        if rel_import_flag:
...
def bootgame(metadata):
    ...
    # Define your plugins list here
    plugins_list = [('esper','esper33'),]  # Add any other plugins like 'plugin_x', 'plugin_y', etc.

    prep_plugins(mon_inj, rel_imports, plugins_list)
    upward_link(mon_inj)
